  ...
  return (
    <div className='fixed w-full h-[80px] flex justify-between items-center px-4 bg-[#000000] text-yellow-300'>
      ...
      <div className='hidden lg:flex fixed flex-col top-[35%] left-0'>
        <ul>
          <li className='w-[160px] h-[60px] flex justify-between items-center ml-[-100px] hover:ml-[-10px] duration-300 bg-blue-00'>
            <a
              className='flex justify-between items-center w-full text-blue-600'
              href='https://www.linkedin.com/in/kingqabil/'
            >
          ...
          <li className='w-[160px] h-[60px] flex justify-between items-center ml-[-100px] hover:ml-[-10px] duration-300 bg-blue-00'>
            <a
              ...
              href='https://angel.co/u/sadiq-habil'
            >
              AngelList <FaAngellist size={30} />
            </a>
          </li>
          <li className='w-[160px] h-[60px] flex justify-between items-center ml-[-100px] hover:ml-[-10px] duration-300 bg-gray-00'>
            <a
              className='flex justify-between items-center w-full text-blue-500'
              href='https://twitter.com/kingqabil'
            >
          ...
          <li className='w-[160px] h-[60px] flex justify-between items-center ml-[-100px] hover:ml-[-10px] duration-300 bg-[#]'>
            <a
              className='flex justify-between items-center w-full text-gray-300'
              href='https://github.com/kingqabil'
            >
